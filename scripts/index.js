...
const profileFormElement = document.forms[0];
...
const editProfileSubmitBtn = profileFormElement.querySelector(".modal__submit-btn");
...
allModals.forEach(modal => modal.querySelector(".modal__exit").addEventListener("click", () => {
